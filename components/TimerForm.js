        ...
        <View style={styles.formContainer}>
            <View style={styles.attributeContainer}>
                ...
                <View style={styles.textInputContainer}>
                    <TextInput style={styles.textInput} onChangeText={this.handleTitleChange} value={title} />
                </View>
            </View>
            <View style={styles.attributeContainer}>
                <Text style={styles.textInputTitle}>Project</Text>
                <View style={styles.textInputContainer}>
                    <TextInput style={styles.textInput} onChangeText={this.handleProjectChange} value={project} />
                </View>
            </View>
